package org.maktab.scheduledlogs.work;
...
import org.maktab.scheduledlogs.utilities.ServiceUtils;
...
public class PollWorker extends Worker {
    ...
    public Result doWork() {
        ServiceUtils.poll(getApplicationContext(), TAG);
    ...
    public static void enqueueWork(Context context, boolean isOn) {
        ...
        if (isOn) {
            ...
            PeriodicWorkRequest periodicWorkRequest =
                    new PeriodicWorkRequest.Builder(org.maktab.scheduledlogs.work.PollWorker.class, 15, TimeUnit.MINUTES)
